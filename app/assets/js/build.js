...
var _landing = require("./modules/landing/landing");
...
App.on("start", function () {
    ...
    App.rootLayout = new _landing2.default({
        el: "#app"
    });
...
},{"./modules/landing/landing":4,"backbone.marionette":5}],2:[function(require,module,exports){
'use strict';
...
Marionette.BossView = Marionette.ItemView.extend({
    ...
    _afterInitializeSubViews: function _afterInitializeSubViews() {
        this._initializeChildViewEvents();
        this._initializeSubViewEventBubbling();
    },

    _initializeSubViews: function _initializeSubViews() {
        this.initializedSubViews = {};
        this._eachSubView(_.bind(this._initializeSubView, this));
    },

    _initializeSubView: function _initializeSubView(subViewName, subViewFunction) {
    ...
    initializeSubView: function initializeSubView(subViewName, subViewFunction) {
        this._initializeSubView(subViewName, subViewFunction);
        this._afterInitializeSubViews();
    },

    _getInitializedSubView: function _getInitializedSubView(subViewFunction) {
        var subView;
    ...
    _initializeRenderableSubView: function _initializeRenderableSubView(subViewFunction) {
    ...
    _checkSubViewForRender: function _checkSubViewForRender(subView, subViewName) {
    ...
    _initializeChildViewEvents: function _initializeChildViewEvents() {
    ...
    _getSubViewEventCallbackFunction: function _getSubViewEventCallbackFunction(subViewEventCallback, subViewEventName) {
    ...
    _listenToEventOnAllSubViews: function _listenToEventOnAllSubViews(subViewEventCallback, subViewEventName) {
    ...
    _checkForSubViewEventCallback: function _checkForSubViewEventCallback(subViewEventCallback, subViewEventName) {
    ...
    _initializeSubViewEventBubbling: function _initializeSubViewEventBubbling() {
        this._eachSubView(_.bind(function (subViewName) {
    ...
    _onParentRendered: function _onParentRendered() {
        this.trigger('subviews:before:render');
        this._renderSubViews();
        this.trigger('subviews:after:render');
    },

    _renderSubViews: function _renderSubViews() {
        this._eachSubView(_.bind(this.renderSubView, this));
    },

    renderSubView: function renderSubView(subViewName) {
    ...
    _renderSubView: function _renderSubView(subViewName, appendToEl) {
    ...
    _shouldRenderSubView: function _shouldRenderSubView(subViewName) {
    ...
    _eachSubView: function _eachSubView(callback) {
    ...
    _eachSubViewEvent: function _eachSubViewEvent(callback) {
    ...
    _splitSubViewEventKey: function _splitSubViewEventKey(subViewEventKey) {
    ...
    _hasSubViewContainer: function _hasSubViewContainer(subViewName) {
    ...
    _getSubViewContainer: function _getSubViewContainer(subViewName) {
        if (!this._hasSubViewContainer(subViewName)) {
    ...
    _removeSubViews: function _removeSubViews() {
        _.each(this.initializedSubViews, function (subView) {
            subView.remove();
        });
    },

    _getSubViews: function _getSubViews() {
    ...
    _getOption: function _getOption(optionName) {
        return this[optionName] || this.options[optionName];
    },

    _getSubViewRenderConditions: function _getSubViewRenderConditions() {
        return this._getOption('subViewRenderConditions') || {};
    }
});

exports.default = Marionette.BossView;

},{"backbone.marionette":5,"underscore":10}],3:[function(require,module,exports){
module.exports = "<div>\n    Yes Hello.\n</div>";
...
var _bossviewEs = require("../../libs/unmanaged/bossview-es6");

var _bossviewEs2 = _interopRequireDefault(_bossviewEs);
...
var Template = _interopRequireWildcard(_landing);
...
var LandingPage = function (_BossView) {
    _inherits(LandingPage, _BossView);
    ...
    function LandingPage() {
        ...
        return _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(LandingPage)).call.apply(_Object$getPrototypeO, [this].concat(args)));
    }
    ...
    return LandingPage;
}(_bossviewEs2.default);

exports.default = LandingPage;

},{"../../libs/unmanaged/bossview-es6":2,"./landing.html":3,"underscore":10}],5:[function(require,module,exports){
...
},{"backbone":8,"backbone.babysitter":6,"backbone.wreqr":7,"underscore":10}],6:[function(require,module,exports){
// Backbone.BabySitter
// -------------------
// v0.1.11
//
...
},{"backbone":8,"underscore":10}],7:[function(require,module,exports){
